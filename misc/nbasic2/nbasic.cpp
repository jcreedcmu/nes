...
int NBasic::Compile(int i)
{
	...
	CompileError("misterioso",tokens.GetToken(i)->line);
	return -1;
}
...
int NBasic::CompileConditional(int i, int type, int line)
{
	...
	else
	{
		...
		{
			case ISEQUAL:	asmlist.AddToken(BNE, autolabel, len, line); break;
			case NOTEQUAL:	asmlist.AddToken(BEQ, autolabel, len, line); break;
			case ISLESS:	asmlist.AddToken(BPL, autolabel, len, line); break;
			case ISGREATER:	asmlist.AddToken(BCC, autolabel, len, line); break;
			case LESSEQ:	asmlist.AddToken(BCS, autolabel, len, line); break;
			case GREATEREQ:	asmlist.AddToken(BMI, autolabel, len, line); break;
